...
@section('title','LogicQP | Reporte Existencias')


@section('page-title','Reporte de Existencias')
				...
				<div class="table-responsive">
					<table class="table table-bordered table-condensed">
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="11" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Existencias Desde {{ date('j M Y',strtotime($start_date)) }} Hasta {{ date('j M Y',strtotime($end_date)) }}</p></td>
