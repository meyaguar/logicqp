...
@section('title','LogicQP | Reporte Despachos')


@section('page-title','Reporte de Despachos')
				...
				<div class="table-responsive">
					<table class="table table-bordered table-condensed">
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="11" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Ventas desde {{ date('j M Y',strtotime($start_date)) }} hasta {{ date('j M Y',strtotime($end_date)) }}</p></td>
