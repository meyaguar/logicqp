...
@section('title','LogicQP | Reporte Utilidades')


@section('page-title','Reporte de Utilidades')
				...
				<div class="table-responsive">
					<table class="table table-bordered table-condensed">
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="5" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Utilidades desde {{ date('j M Y',strtotime($start_date)) }} hasta {{ date('j M Y',strtotime($end_date)) }}</p></td>
