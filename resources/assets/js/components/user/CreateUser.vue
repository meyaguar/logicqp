							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="input-group">
										...
										<div class="form-line">
											<input type="password" class="form-control date" placeholder="Ingresa tu contraseña"
								...
								<div class="col-md-6">
									<div class="input-group">
										...
										<div class="form-line">
											<input type="password" class="form-control date" placeholder="Reingresa tu contraseña"
