      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="defaultModalLabel">Informacion de la ubicación</h4>
          </div>
          <div class="modal-body">
            ...
            <form>
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group">
                    <span class="input-group-addon">
                      <i class="material-icons">wharehouse</i>
                    </span>
                    <div class="form-line">
                ...
                <div v-show="false" style="display: none !important"  class="col-md-12">
                  <div class="input-group">
                    <span class="input-group-addon">
                ...
                <div class="col-md-12">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text" class="form-control date" placeholder="Detalles" v-model="vendor.address" />
                    </div>
                  </div>
                </div>
              </div>
