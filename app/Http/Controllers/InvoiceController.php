...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
           ...
           // invoice 
            ...
            return response()->json(['status' => 'success', 'message' => '¡Despacho creado!']);
            }
               catch(\Exception $e){
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
         ...
         $details = SellDetails::where('sell_id','=',$id)->get();
            ...
            return response()->json(['status' => 'success', 'message' => 'Despacho actualizado!']);
            }
               catch(\Exception $e){
    ...
    public function destroy($id)
    {
        ...
        try{
           ...
           return response()->json(['status' => 'success', 'message' => 'Despacho eliminado!']);
