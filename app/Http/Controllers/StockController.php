   ...
   return $chalan;
    ...
    public function store(Request $request)
    {
      ...
      try{
        ...
        // HACK : LOTE (stocks.chalan_no) - cambio de formato
        $stock->chalan_no = date('Y-m-d-Hi');
  ...
  public function StockUpdate(Request $request){
    ...
    public function destroy($id)
    {
      ...
      if($check > 0){
       ...
       return response()->json(['status'=>'error','message'=>'Este despacho tiene registros, eliminar los artículos primero']);
